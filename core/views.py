            ...
            if form.is_valid(): 
                ...
                if use_default_shipping:
                    ...
                    if address_qs.exists():
                        ...
                        messages.info(self.request,"no default shipping address avalibel")
                        return redirect('core:check-out')
                else:
                ...
                if same_billing_address:
                    ...
                    if address_qs.exists():
                        ...
                        messages.info(self.request,"no default billing address avalibel")
                        return redirect('core:check-out')
                else:
                    print("User is entering a new address")
...
class PaymentView(View): 
    def get(self, *args, **kwargs):       
        ...
        if order.billing_address:
            ...
            if userprofile.one_click_purchasing:
                ...
                if len(card_list)>0:
                    #update the context with the default value
                    context.update({
                        'card':card_list[0]
                    })
    ...
    def post(self, *args, **kwargs): 
        ...
        try:
            ...
            messages.warning(self.request, "Serious Error occured and we have been notified")
